...
public class SuperDuperNetwork
{
	...
	{
		CHANNEL.registerMessage(ID++, UpdateTamerCapabilityPacket.class, UpdateTamerCapabilityPacket::encode, UpdateTamerCapabilityPacket::new, UpdateTamerCapabilityPacket.Handler::onMessage);
	}
